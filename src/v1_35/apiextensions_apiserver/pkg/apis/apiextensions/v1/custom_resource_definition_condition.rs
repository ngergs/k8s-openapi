...
impl crate::schemars::JsonSchema for CustomResourceDefinitionCondition {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.CustomResourceDefinitionCondition".into()
    }
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                "lastTransitionTime": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "lastTransitionTime last time the condition transitioned from one status to another.".into());
                    schema_obj
                }),
                "message": {
...
impl crate::schemars08::JsonSchema for CustomResourceDefinitionCondition {
    ...
    fn json_schema(__gen: &mut crate::schemars08::gen::SchemaGenerator) -> crate::schemars08::schema::Schema {
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                description: Some("CustomResourceDefinitionCondition contains details for the current condition of this pod.".into()),
                ..Default::default()
            })),
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    (
                        "lastTransitionTime".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("lastTransitionTime last time the condition transitioned from one status to another.".into()),
                                ..Default::default()
                            }));
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("type is the type of the condition. Types include Established, NamesAccepted and Terminating.".into()),
                                ..Default::default()
                            })),
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::String))),
                            ..Default::default()
