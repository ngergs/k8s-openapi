...
pub struct NodeSystemInfo {
    ...
    pub swap: Option<crate::api::core::v1::NodeSwapStatus>,
...
impl crate::DeepMerge for NodeSystemInfo {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::DeepMerge::merge_from(&mut self.swap, other.swap);
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_swap: Option<crate::api::core::v1::NodeSwapStatus> = None;
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_swap => value_swap = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for NodeSystemInfo {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.swap {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "swap", value)?;
        }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "swap": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::core::v1::NodeSwapStatus>();
                    schema_obj.ensure_object().insert("description".into(), "Swap Info reported by the node.".into());
                    schema_obj
                }),
                "systemUUID": {
...
impl crate::schemars08::JsonSchema for NodeSystemInfo {
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("Deprecated: KubeProxy Version reported by the node.".into()),
                                ..Default::default()
                            })),
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::String))),
                            ..Default::default()
                    ...
                    (
                        "swap".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::core::v1::NodeSwapStatus>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("Swap Info reported by the node.".into()),
                                ..Default::default()
                            }));
