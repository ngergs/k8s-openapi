...
pub struct EnvVarSource {
    ...
    pub file_key_ref: Option<crate::api::core::v1::FileKeySelector>,
...
impl crate::DeepMerge for EnvVarSource {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::DeepMerge::merge_from(&mut self.file_key_ref, other.file_key_ref);
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
                ...
                impl crate::serde::de::Visitor<'_> for Visitor {
                    ...
                    fn visit_str<E>(self, v: &str) -> Result<Self::Value, E> where E: crate::serde::de::Error {
                        Ok(match v {
                            ...
                            "fileKeyRef" => Field::Key_file_key_ref,
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_file_key_ref: Option<crate::api::core::v1::FileKeySelector> = None;
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_file_key_ref => value_file_key_ref = crate::serde::de::MapAccess::next_value(&mut map)?,
                ...
                Ok(EnvVarSource {
                    ...
                    file_key_ref: value_file_key_ref,
...
impl crate::serde::Serialize for EnvVarSource {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        let mut state = serializer.serialize_struct(
            ...
            self.file_key_ref.as_ref().map_or(0, |_| 1) +
        ...
        if let Some(value) = &self.file_key_ref {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "fileKeyRef", value)?;
        }
...
impl crate::schemars::JsonSchema for EnvVarSource {
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                "configMapKeyRef": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::core::v1::ConfigMapKeySelector>();
                    schema_obj.ensure_object().insert("description".into(), "Selects a key of a ConfigMap.".into());
                    schema_obj
                }),
                "fieldRef": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::core::v1::ObjectFieldSelector>();
                    schema_obj.ensure_object().insert("description".into(), "Selects a field of the pod: supports metadata.name, metadata.namespace, `metadata.labels['<KEY>']`, `metadata.annotations['<KEY>']`, spec.nodeName, spec.serviceAccountName, status.hostIP, status.podIP, status.podIPs.".into());
                    schema_obj
                }),
                "fileKeyRef": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::core::v1::FileKeySelector>();
                    schema_obj.ensure_object().insert("description".into(), "FileKeyRef selects a key of the env file. Requires the EnvFiles feature gate to be enabled.".into());
                    schema_obj
                }),
                "resourceFieldRef": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::core::v1::ResourceFieldSelector>();
                    schema_obj.ensure_object().insert("description".into(), "Selects a resource of the container: only resources limits and requests (limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported.".into());
                    schema_obj
                }),
                "secretKeyRef": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::core::v1::SecretKeySelector>();
                    schema_obj.ensure_object().insert("description".into(), "Selects a key of a secret in the pod's namespace".into());
                    schema_obj
                }),
            },
        })
...
impl crate::schemars08::JsonSchema for EnvVarSource {
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "fileKeyRef".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::core::v1::FileKeySelector>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("FileKeyRef selects a key of the env file. Requires the EnvFiles feature gate to be enabled.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
