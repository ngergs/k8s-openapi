...
impl crate::schemars::JsonSchema for Eviction {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.policy.v1.Eviction".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "deleteOptions": ({
                    let mut schema_obj = __gen.subschema_for::<crate::apimachinery::pkg::apis::meta::v1::DeleteOptions>();
                    schema_obj.ensure_object().insert("description".into(), "DeleteOptions may be provided".into());
                    schema_obj
                }),
                "kind": {
                ...
                "metadata": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "ObjectMeta describes the pod that is being evicted.".into());
                    schema_obj
                }),
            },
            "required": [
    ...
    fn json_schema(__gen: &mut crate::schemars08::gen::SchemaGenerator) -> crate::schemars08::schema::Schema {
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                description: Some("Eviction evicts a pod from its node subject to certain policies and safety constraints. This is a subresource of Pod.  A request to cause such an eviction is created by POSTing to .../pods/<pod name>/evictions.".into()),
                ..Default::default()
            })),
                ...
                properties: [
                    ...
                    (
                        "deleteOptions".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("DeleteOptions may be provided".into()),
                                ..Default::default()
                            }));
                    ...
                    (
                        "metadata".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("ObjectMeta describes the pod that is being evicted.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
