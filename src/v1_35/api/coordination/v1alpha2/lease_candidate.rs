// Generated from definition io.k8s.api.coordination.v1alpha2.LeaseCandidate
...
pub struct LeaseCandidate {
    ...
    pub spec: Option<crate::api::coordination::v1alpha2::LeaseCandidateSpec>,
}
...
impl crate::ListableResource for LeaseCandidate {
    const LIST_KIND: &'static str = "LeaseCandidateList";
}
...
impl crate::DeepMerge for LeaseCandidate {
...
impl<'de> crate::serde::Deserialize<'de> for LeaseCandidate {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::api::coordination::v1alpha2::LeaseCandidateSpec> = None;
...
impl crate::serde::Serialize for LeaseCandidate {
...
impl crate::schemars::JsonSchema for LeaseCandidate {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.coordination.v1alpha2.LeaseCandidate".into()
    }
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "metadata": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata".into());
                    schema_obj
                }),
                "spec": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::coordination::v1alpha2::LeaseCandidateSpec>();
                    schema_obj.ensure_object().insert("description".into(), "spec contains the specification of the Lease. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status".into());
                    schema_obj
                }),
            },
            "required": [
...
impl crate::schemars08::JsonSchema for LeaseCandidate {
    ...
    fn json_schema(__gen: &mut crate::schemars08::gen::SchemaGenerator) -> crate::schemars08::schema::Schema {
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                description: Some("LeaseCandidate defines a candidate for a Lease object. Candidates are created such that coordinated leader election will pick the best leader from the list of candidates.".into()),
                ..Default::default()
            })),
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "spec".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::coordination::v1alpha2::LeaseCandidateSpec>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("spec contains the specification of the Lease. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
