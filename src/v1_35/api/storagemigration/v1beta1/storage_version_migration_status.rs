// Generated from definition io.k8s.api.storagemigration.v1beta1.StorageVersionMigrationStatus
...
impl crate::schemars::JsonSchema for StorageVersionMigrationStatus {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.storagemigration.v1beta1.StorageVersionMigrationStatus".into()
    }
