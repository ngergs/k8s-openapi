// Generated from definition io.k8s.api.flowcontrol.v1.UserSubject
...
impl crate::schemars::JsonSchema for UserSubject {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.flowcontrol.v1.UserSubject".into()
    }
...
impl crate::schemars08::JsonSchema for UserSubject {
    ...
    fn json_schema(__gen: &mut crate::schemars08::gen::SchemaGenerator) -> crate::schemars08::schema::Schema {
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                description: Some("UserSubject holds detailed information for user-kind subject.".into()),
                ..Default::default()
            })),
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("`name` is the username that matches, or \"*\" to match all usernames. Required.".into()),
                                ..Default::default()
                            })),
