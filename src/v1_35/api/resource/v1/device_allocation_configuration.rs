// Generated from definition io.k8s.api.resource.v1.DeviceAllocationConfiguration
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_opaque: Option<crate::api::resource::v1::OpaqueDeviceConfiguration> = None;
...
impl crate::schemars::JsonSchema for DeviceAllocationConfiguration {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.resource.v1.DeviceAllocationConfiguration".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                "opaque": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1::OpaqueDeviceConfiguration>();
...
impl crate::schemars08::JsonSchema for DeviceAllocationConfiguration {
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    (
                        "opaque".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1::OpaqueDeviceConfiguration>().into_object();
