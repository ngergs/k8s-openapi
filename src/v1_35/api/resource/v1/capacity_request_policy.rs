// Generated from definition io.k8s.api.resource.v1.CapacityRequestPolicy
...
pub struct CapacityRequestPolicy {
    ...
    pub valid_range: Option<crate::api::resource::v1::CapacityRequestPolicyRange>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_valid_range: Option<crate::api::resource::v1::CapacityRequestPolicyRange> = None;
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "validRange": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1::CapacityRequestPolicyRange>();
