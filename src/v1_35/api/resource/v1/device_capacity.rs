// Generated from definition io.k8s.api.resource.v1.DeviceCapacity
...
pub struct DeviceCapacity {
    ...
    pub request_policy: Option<crate::api::resource::v1::CapacityRequestPolicy>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_request_policy: Option<crate::api::resource::v1::CapacityRequestPolicy> = None;
...
impl crate::schemars::JsonSchema for DeviceCapacity {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.resource.v1.DeviceCapacity".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                "requestPolicy": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1::CapacityRequestPolicy>();
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    (
                        "requestPolicy".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1::CapacityRequestPolicy>().into_object();
