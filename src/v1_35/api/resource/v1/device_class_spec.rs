// Generated from definition io.k8s.api.resource.v1.DeviceClassSpec
...
pub struct DeviceClassSpec {
    ...
    pub config: Option<std::vec::Vec<crate::api::resource::v1::DeviceClassConfiguration>>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_config: Option<std::vec::Vec<crate::api::resource::v1::DeviceClassConfiguration>> = None;
...
impl crate::schemars::JsonSchema for DeviceClassSpec {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.resource.v1.DeviceClassSpec".into()
    }
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                "config": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::resource::v1::DeviceClassConfiguration>()),
                },
                "extendedResourceName": {
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::resource::v1::DeviceClassConfiguration>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
