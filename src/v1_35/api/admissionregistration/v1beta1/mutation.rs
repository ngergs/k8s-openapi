// Generated from definition io.k8s.api.admissionregistration.v1beta1.Mutation
...
pub struct Mutation {
    ...
    pub apply_configuration: Option<crate::api::admissionregistration::v1beta1::ApplyConfiguration>,
    ...
    pub json_patch: Option<crate::api::admissionregistration::v1beta1::JSONPatch>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_apply_configuration: Option<crate::api::admissionregistration::v1beta1::ApplyConfiguration> = None;
                let mut value_json_patch: Option<crate::api::admissionregistration::v1beta1::JSONPatch> = None;
...
impl crate::schemars::JsonSchema for Mutation {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.admissionregistration.v1beta1.Mutation".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                "applyConfiguration": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::admissionregistration::v1beta1::ApplyConfiguration>();
                ...
                "jsonPatch": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::admissionregistration::v1beta1::JSONPatch>();
...
impl crate::schemars08::JsonSchema for Mutation {
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    (
                        ...
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::admissionregistration::v1beta1::ApplyConfiguration>().into_object();
                    ...
                    (
                        "jsonPatch".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::admissionregistration::v1beta1::JSONPatch>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
