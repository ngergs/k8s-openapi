// Generated from definition io.k8s.api.networking.v1beta1.IPAddressSpec

/// IPAddressSpec describe the attributes in an IP Address.
#[derive(Clone, Debug, Default, PartialEq, fake::Dummy)]
pub struct IPAddressSpec {
    /// ParentRef references the resource that an IPAddress is attached to. An IPAddress must reference a parent object.
    pub parent_ref: crate::api::networking::v1beta1::ParentReference,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_parent_ref: Option<crate::api::networking::v1beta1::ParentReference> = None;
...
impl crate::schemars08::JsonSchema for IPAddressSpec {
