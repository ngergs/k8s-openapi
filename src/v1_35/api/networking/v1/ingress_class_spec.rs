    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "parameters": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::networking::v1::IngressClassParametersReference>();
                    schema_obj.ensure_object().insert("description".into(), "parameters is a link to a custom resource containing additional configuration for the controller. This is optional if the controller does not require extra parameters.".into());
                    schema_obj
                }),
            },
        })
...
impl crate::schemars08::JsonSchema for IngressClassSpec {
