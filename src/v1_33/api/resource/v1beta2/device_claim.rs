// Generated from definition io.k8s.api.resource.v1beta2.DeviceClaim

/// DeviceClaim defines how to request devices with a ResourceClaim.
#[derive(Clone, Debug, Default, PartialEq, fake::Dummy)]
pub struct DeviceClaim {
    /// This field holds configuration for multiple potential drivers which could satisfy requests in this claim. It is ignored while allocating the claim.
    pub config: Option<std::vec::Vec<crate::api::resource::v1beta2::DeviceClaimConfiguration>>,

    /// These constraints must be satisfied by the set of devices that get allocated for the claim.
    pub constraints: Option<std::vec::Vec<crate::api::resource::v1beta2::DeviceConstraint>>,

    /// Requests represent individual requests for distinct devices which must all be satisfied. If empty, nothing needs to be allocated.
    pub requests: Option<std::vec::Vec<crate::api::resource::v1beta2::DeviceRequest>>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_config: Option<std::vec::Vec<crate::api::resource::v1beta2::DeviceClaimConfiguration>> = None;
                let mut value_constraints: Option<std::vec::Vec<crate::api::resource::v1beta2::DeviceConstraint>> = None;
                let mut value_requests: Option<std::vec::Vec<crate::api::resource::v1beta2::DeviceRequest>> = None;
...
impl crate::schemars::JsonSchema for DeviceClaim {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.resource.v1beta2.DeviceClaim".into()
    }
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                "config": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::resource::v1beta2::DeviceClaimConfiguration>()),
                },
                "constraints": {
                    "description": "These constraints must be satisfied by the set of devices that get allocated for the claim.",
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::resource::v1beta2::DeviceConstraint>()),
                },
                "requests": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::resource::v1beta2::DeviceRequest>()),
                },
            },
        })
    }
...
impl crate::schemars08::JsonSchema for DeviceClaim {
                ...
                properties: [
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::resource::v1beta2::DeviceClaimConfiguration>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::Array))),
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::resource::v1beta2::DeviceConstraint>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::Array))),
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::resource::v1beta2::DeviceRequest>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
