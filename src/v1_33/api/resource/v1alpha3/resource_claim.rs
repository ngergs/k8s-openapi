// Generated from definition io.k8s.api.resource.v1alpha3.ResourceClaim
...
pub struct ResourceClaim {
    ...
    pub spec: crate::api::resource::v1alpha3::ResourceClaimSpec,

    /// Status describes whether the claim is ready to use and what has been allocated.
    pub status: Option<crate::api::resource::v1alpha3::ResourceClaimStatus>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::api::resource::v1alpha3::ResourceClaimSpec> = None;
                let mut value_status: Option<crate::api::resource::v1alpha3::ResourceClaimStatus> = None;
...
impl crate::schemars::JsonSchema for ResourceClaim {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.resource.v1alpha3.ResourceClaim".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "spec": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1alpha3::ResourceClaimSpec>();
                ...
                "status": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1alpha3::ResourceClaimStatus>();
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "spec".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1alpha3::ResourceClaimSpec>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                    ...
                    (
                        "status".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1alpha3::ResourceClaimStatus>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
