// Generated from definition io.k8s.api.resource.v1alpha3.CELDeviceSelector
...
impl crate::schemars::JsonSchema for CELDeviceSelector {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.resource.v1alpha3.CELDeviceSelector".into()
    }
...
impl crate::schemars08::JsonSchema for CELDeviceSelector {
