// Generated from definition io.k8s.api.flowcontrol.v1.Subject

/// Subject matches the originator of a request, as identified by the request authentication system. There are three ways of matching an originator; by user, group, or service account.
#[derive(Clone, Debug, Default, PartialEq, fake::Dummy)]
pub struct Subject {
    /// `group` matches based on user group name.
    pub group: Option<crate::api::flowcontrol::v1::GroupSubject>,

    /// `kind` indicates which one of the other fields is non-empty. Required
    pub kind: std::string::String,

    /// `serviceAccount` matches ServiceAccounts.
    pub service_account: Option<crate::api::flowcontrol::v1::ServiceAccountSubject>,

    /// `user` matches based on username.
    pub user: Option<crate::api::flowcontrol::v1::UserSubject>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_group: Option<crate::api::flowcontrol::v1::GroupSubject> = None;
                let mut value_kind: Option<std::string::String> = None;
                let mut value_service_account: Option<crate::api::flowcontrol::v1::ServiceAccountSubject> = None;
                let mut value_user: Option<crate::api::flowcontrol::v1::UserSubject> = None;
...
impl crate::schemars08::JsonSchema for Subject {
