        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "averageValue": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "averageValue is the current value of the average of the metric across all relevant pods (as a quantity)".into());
                    schema_obj
                }),
                "value": ({
                    let mut schema_obj = __gen.subschema_for::<crate::apimachinery::pkg::api::resource::Quantity>();
                    schema_obj.ensure_object().insert("description".into(), "value is the current value of the metric (as a quantity).".into());
                    schema_obj
                }),
            },
        })
...
impl crate::schemars08::JsonSchema for MetricValueStatus {
