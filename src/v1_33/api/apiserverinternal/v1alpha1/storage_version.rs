        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "metadata": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "The name is <group>.<resource>.".into());
                    schema_obj
                }),
                "spec": ({
                ...
                "status": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "API server instances report the version they can decode and the version they encode objects to when persisting objects in the backend.".into());
                    schema_obj
                }),
            },
            "required": [
                ...
                properties: [
                    ...
                    (
                        "metadata".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("The name is <group>.<resource>.".into()),
                                ..Default::default()
                            }));
                    ...
                    (
                        "status".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("API server instances report the version they can decode and the version they encode objects to when persisting objects in the backend.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
