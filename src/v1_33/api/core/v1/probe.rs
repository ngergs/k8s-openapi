        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "grpc": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "GRPC specifies a GRPC HealthCheckRequest.".into());
                    schema_obj
                }),
                "httpGet": ({
                ...
                "tcpSocket": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "TCPSocket specifies a connection to a TCP port.".into());
                    schema_obj
                }),
                "terminationGracePeriodSeconds": {
...
impl crate::schemars08::JsonSchema for Probe {
                ...
                properties: [
                    ...
                    (
                        "grpc".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("GRPC specifies a GRPC HealthCheckRequest.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
                    ...
                    (
                        "tcpSocket".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("TCPSocket specifies a connection to a TCP port.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
