        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                "startedAt": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "Time at which the container was last (re-)started".into());
                    schema_obj
                }),
            },
        })
...
impl crate::schemars08::JsonSchema for ContainerStateRunning {
