...
impl crate::schemars::JsonSchema for ReplicationControllerCondition {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.core.v1.ReplicationControllerCondition".into()
    }
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                "lastTransitionTime": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "The last time the condition transitioned from one status to another.".into());
                    schema_obj
                }),
                "message": {
...
impl crate::schemars08::JsonSchema for ReplicationControllerCondition {
    ...
    fn json_schema(__gen: &mut crate::schemars08::gen::SchemaGenerator) -> crate::schemars08::schema::Schema {
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                description: Some("ReplicationControllerCondition describes the state of a replication controller at a certain point.".into()),
                ..Default::default()
            })),
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    (
                        "lastTransitionTime".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("The last time the condition transitioned from one status to another.".into()),
                                ..Default::default()
                            }));
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("Type of replication controller condition.".into()),
                                ..Default::default()
                            })),
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::String))),
                            ..Default::default()
