...
pub struct Endpoints {
    ...
    pub subsets: Option<std::vec::Vec<crate::api::core::v1::EndpointSubset>>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_subsets: Option<std::vec::Vec<crate::api::core::v1::EndpointSubset>> = None;
...
impl crate::schemars::JsonSchema for Endpoints {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.core.v1.Endpoints".into()
    }
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "subsets": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::core::v1::EndpointSubset>()),
                },
            },
            "required": [
                "metadata",
...
impl crate::schemars08::JsonSchema for Endpoints {
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::core::v1::EndpointSubset>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
