// Generated from definition io.k8s.api.networking.v1.IngressPortStatus
...
impl crate::DeepMerge for IngressPortStatus {
...
impl<'de> crate::serde::Deserialize<'de> for IngressPortStatus {
...
impl crate::serde::Serialize for IngressPortStatus {
...
impl crate::schemars::JsonSchema for IngressPortStatus {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.networking.v1.IngressPortStatus".into()
    }
...
impl crate::schemars08::JsonSchema for IngressPortStatus {
    ...
    fn json_schema(__gen: &mut crate::schemars08::gen::SchemaGenerator) -> crate::schemars08::schema::Schema {
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                description: Some("IngressPortStatus represents the error condition of a service port".into()),
                ..Default::default()
            })),
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("port is the port number of the ingress port.".into()),
                                ..Default::default()
                            })),
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("protocol is the protocol of the ingress port. The supported values are: \"TCP\", \"UDP\", \"SCTP\"".into()),
                                ..Default::default()
                            })),
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::String))),
                            ..Default::default()
