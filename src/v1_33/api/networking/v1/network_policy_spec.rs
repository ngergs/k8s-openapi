        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "podSelector": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "podSelector selects the pods to which this NetworkPolicy object applies. The array of ingress rules is applied to any pods selected by this field. Multiple network policies can select the same set of pods. In this case, the ingress rules for each are combined additively. This field is NOT optional and follows standard label selector semantics. An empty podSelector matches all pods in this namespace.".into());
                    schema_obj
                }),
                "policyTypes": {
