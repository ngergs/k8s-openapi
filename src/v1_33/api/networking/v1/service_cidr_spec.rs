// Generated from definition io.k8s.api.networking.v1.ServiceCIDRSpec
...
impl crate::schemars::JsonSchema for ServiceCIDRSpec {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.networking.v1.ServiceCIDRSpec".into()
    }
...
impl crate::schemars08::JsonSchema for ServiceCIDRSpec {
