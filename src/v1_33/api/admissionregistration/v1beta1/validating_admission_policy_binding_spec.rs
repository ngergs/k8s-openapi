// Generated from definition io.k8s.api.admissionregistration.v1beta1.ValidatingAdmissionPolicyBindingSpec
...
pub struct ValidatingAdmissionPolicyBindingSpec {
    ...
    pub match_resources: Option<crate::api::admissionregistration::v1beta1::MatchResources>,

    /// paramRef specifies the parameter resource used to configure the admission control policy. It should point to a resource of the type specified in ParamKind of the bound ValidatingAdmissionPolicy. If the policy specifies a ParamKind and the resource referred to by ParamRef does not exist, this binding is considered mis-configured and the FailurePolicy of the ValidatingAdmissionPolicy applied. If the policy does not specify a ParamKind then this field is ignored, and the rules are evaluated without a param.
    pub param_ref: Option<crate::api::admissionregistration::v1beta1::ParamRef>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_match_resources: Option<crate::api::admissionregistration::v1beta1::MatchResources> = None;
                let mut value_param_ref: Option<crate::api::admissionregistration::v1beta1::ParamRef> = None;
...
impl crate::schemars::JsonSchema for ValidatingAdmissionPolicyBindingSpec {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.admissionregistration.v1beta1.ValidatingAdmissionPolicyBindingSpec".into()
    }
...
impl crate::schemars08::JsonSchema for ValidatingAdmissionPolicyBindingSpec {
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "paramRef".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::admissionregistration::v1beta1::ParamRef>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
