// Generated from definition io.k8s.api.admissionregistration.v1alpha1.ParamRef
...
impl crate::schemars::JsonSchema for ParamRef {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.admissionregistration.v1alpha1.ParamRef".into()
    }
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "selector": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "selector can be used to match multiple param objects based on their labels. Supply selector: {} to match all resources of the ParamKind.\n\nIf multiple params are found, they are all evaluated with the policy expressions and the results are ANDed together.\n\nOne of `name` or `selector` must be set, but `name` and `selector` are mutually exclusive properties. If one is set, the other must be unset.".into());
                    schema_obj
                }),
            },
        })
...
impl crate::schemars08::JsonSchema for ParamRef {
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("`name` is the name of the resource being referenced.\n\n`name` and `selector` are mutually exclusive properties. If one is set, the other must be unset.".into()),
                                ..Default::default()
                            })),
