// Generated from definition io.k8s.api.flowcontrol.v1beta3.PriorityLevelConfigurationCondition
...
impl crate::schemars::JsonSchema for PriorityLevelConfigurationCondition {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.flowcontrol.v1beta3.PriorityLevelConfigurationCondition".into()
    }
