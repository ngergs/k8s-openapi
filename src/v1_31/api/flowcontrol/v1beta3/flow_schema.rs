// Generated from definition io.k8s.api.flowcontrol.v1beta3.FlowSchema
...
pub struct FlowSchema {
    ...
    pub spec: Option<crate::api::flowcontrol::v1beta3::FlowSchemaSpec>,

    /// `status` is the current status of a FlowSchema. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    pub status: Option<crate::api::flowcontrol::v1beta3::FlowSchemaStatus>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::api::flowcontrol::v1beta3::FlowSchemaSpec> = None;
                let mut value_status: Option<crate::api::flowcontrol::v1beta3::FlowSchemaStatus> = None;
...
impl crate::schemars::JsonSchema for FlowSchema {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.flowcontrol.v1beta3.FlowSchema".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "spec": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::flowcontrol::v1beta3::FlowSchemaSpec>();
                ...
                "status": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::flowcontrol::v1beta3::FlowSchemaStatus>();
