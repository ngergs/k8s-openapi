// Generated from definition io.k8s.api.authentication.v1alpha1.SelfSubjectReview
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_status: Option<crate::api::authentication::v1alpha1::SelfSubjectReviewStatus> = None;
...
impl crate::schemars::JsonSchema for SelfSubjectReview {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.authentication.v1alpha1.SelfSubjectReview".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "status": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::authentication::v1alpha1::SelfSubjectReviewStatus>();
