// Generated from definition io.k8s.api.resource.v1alpha3.PodSchedulingContext
...
pub struct PodSchedulingContext {
    ...
    pub spec: crate::api::resource::v1alpha3::PodSchedulingContextSpec,

    /// Status describes where resources for the Pod can be allocated.
    pub status: Option<crate::api::resource::v1alpha3::PodSchedulingContextStatus>,
}
...
impl crate::ListableResource for PodSchedulingContext {
    const LIST_KIND: &'static str = "PodSchedulingContextList";
}
...
impl crate::DeepMerge for PodSchedulingContext {
...
impl<'de> crate::serde::Deserialize<'de> for PodSchedulingContext {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            type Value = PodSchedulingContext;
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::api::resource::v1alpha3::PodSchedulingContextSpec> = None;
                let mut value_status: Option<crate::api::resource::v1alpha3::PodSchedulingContextStatus> = None;
...
impl crate::serde::Serialize for PodSchedulingContext {
...
impl crate::schemars::JsonSchema for PodSchedulingContext {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.resource.v1alpha3.PodSchedulingContext".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "spec": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1alpha3::PodSchedulingContextSpec>();
                    schema_obj.ensure_object().insert("description".into(), "Spec describes where resources for the Pod are needed.".into());
                    schema_obj
                }),
                "status": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1alpha3::PodSchedulingContextStatus>();
                    schema_obj.ensure_object().insert("description".into(), "Status describes where resources for the Pod can be allocated.".into());
                    schema_obj
                }),
            },
            "required": [
