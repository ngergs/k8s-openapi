        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "parameters": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "Parameters can contain arbitrary data. It is the responsibility of the driver developer to handle validation and versioning. Typically this includes self-identification and a version (\"kind\" + \"apiVersion\" for Kubernetes types), with conversion between different versions.".into());
                    schema_obj
                }),
            },
            "required": [
