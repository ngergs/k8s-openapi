        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                "metadata": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "ObjectMeta may contain labels and annotations that will be copied into the PVC when creating it. No other fields are allowed and will be rejected during validation.".into());
                    schema_obj
                }),
                "spec": ({
