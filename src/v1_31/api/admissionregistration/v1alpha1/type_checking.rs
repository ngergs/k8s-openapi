    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_expression_warnings: Option<std::vec::Vec<crate::api::admissionregistration::v1alpha1::ExpressionWarning>> = None;
...
impl crate::schemars::JsonSchema for TypeChecking {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.admissionregistration.v1alpha1.TypeChecking".into()
    }
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                "expressionWarnings": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::admissionregistration::v1alpha1::ExpressionWarning>()),
                },
            },
        })
    }
