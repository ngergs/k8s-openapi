// Generated from definition io.k8s.api.storagemigration.v1beta1.StorageVersionMigration
...
pub struct StorageVersionMigration {
    ...
    pub spec: Option<crate::api::storagemigration::v1beta1::StorageVersionMigrationSpec>,

    /// Status of the migration.
    pub status: Option<crate::api::storagemigration::v1beta1::StorageVersionMigrationStatus>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::api::storagemigration::v1beta1::StorageVersionMigrationSpec> = None;
                let mut value_status: Option<crate::api::storagemigration::v1beta1::StorageVersionMigrationStatus> = None;
...
impl crate::schemars::JsonSchema for StorageVersionMigration {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.storagemigration.v1beta1.StorageVersionMigration".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "spec": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::storagemigration::v1beta1::StorageVersionMigrationSpec>();
                    schema_obj.ensure_object().insert("description".into(), "Specification of the migration.".into());
                    schema_obj
                }),
                "status": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::storagemigration::v1beta1::StorageVersionMigrationStatus>();
                    schema_obj.ensure_object().insert("description".into(), "Status of the migration.".into());
                    schema_obj
                }),
            },
            "required": [
...
impl crate::schemars08::JsonSchema for StorageVersionMigration {
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "spec".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::storagemigration::v1beta1::StorageVersionMigrationSpec>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                    ...
                    (
                        "status".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::storagemigration::v1beta1::StorageVersionMigrationStatus>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
