// Generated from definition io.k8s.api.admissionregistration.v1alpha1.ParamKind
...
impl crate::schemars::JsonSchema for ParamKind {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.admissionregistration.v1alpha1.ParamKind".into()
    }
...
impl crate::schemars08::JsonSchema for ParamKind {
