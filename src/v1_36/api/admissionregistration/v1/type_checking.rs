// Generated from definition io.k8s.api.admissionregistration.v1.TypeChecking
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                "expressionWarnings": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::admissionregistration::v1::ExpressionWarning>()),
                },
            },
        })
    }
...
impl crate::schemars08::JsonSchema for TypeChecking {
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("expressionWarnings contains the type checking warnings for each expression.".into()),
                                ..Default::default()
                            })),
                            ...
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::admissionregistration::v1::ExpressionWarning>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
