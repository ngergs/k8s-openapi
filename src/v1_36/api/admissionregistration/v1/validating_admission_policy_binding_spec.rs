...
pub struct ValidatingAdmissionPolicyBindingSpec {
    ...
    ///
    /// Required.
    pub validation_actions: std::vec::Vec<std::string::String>,
}
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                Ok(ValidatingAdmissionPolicyBindingSpec {
                    ...
                    policy_name: value_policy_name.unwrap_or_default(),
                    validation_actions: value_validation_actions.unwrap_or_default(),
                })
            }
        }
...
impl crate::serde::Serialize for ValidatingAdmissionPolicyBindingSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        crate::serde::ser::SerializeStruct::serialize_field(&mut state, "policyName", &self.policy_name)?;
        crate::serde::ser::SerializeStruct::serialize_field(&mut state, "validationActions", &self.validation_actions)?;
