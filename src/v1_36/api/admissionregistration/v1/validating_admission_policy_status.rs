// Generated from definition io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicyStatus
...
pub struct ValidatingAdmissionPolicyStatus {
    ...
    pub type_checking: Option<crate::api::admissionregistration::v1::TypeChecking>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_type_checking: Option<crate::api::admissionregistration::v1::TypeChecking> = None;
...
impl crate::schemars::JsonSchema for ValidatingAdmissionPolicyStatus {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicyStatus".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "typeChecking": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::admissionregistration::v1::TypeChecking>();
                    schema_obj.ensure_object().insert("description".into(), "typeChecking contains the results of type checking for each expression. Presence of this field indicates the completion of the type checking.".into());
                    schema_obj
                }),
            },
        })
...
impl crate::schemars08::JsonSchema for ValidatingAdmissionPolicyStatus {
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("conditions represent the latest available observations of a policy's current state.".into()),
                                ..Default::default()
                            })),
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("observedGeneration is the generation observed by the controller.".into()),
                                ..Default::default()
                            })),
                    ...
                    (
                        "typeChecking".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::admissionregistration::v1::TypeChecking>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("typeChecking contains the results of type checking for each expression. Presence of this field indicates the completion of the type checking.".into()),
                                ..Default::default()
                            }));
