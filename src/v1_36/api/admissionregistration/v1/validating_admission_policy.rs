...
pub struct ValidatingAdmissionPolicy {
    ...
    pub spec: Option<crate::api::admissionregistration::v1::ValidatingAdmissionPolicySpec>,
    ...
    pub status: Option<crate::api::admissionregistration::v1::ValidatingAdmissionPolicyStatus>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::api::admissionregistration::v1::ValidatingAdmissionPolicySpec> = None;
                let mut value_status: Option<crate::api::admissionregistration::v1::ValidatingAdmissionPolicyStatus> = None;
...
impl crate::schemars::JsonSchema for ValidatingAdmissionPolicy {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicy".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "spec": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::admissionregistration::v1::ValidatingAdmissionPolicySpec>();
                    schema_obj.ensure_object().insert("description".into(), "spec defines the desired behavior of the ValidatingAdmissionPolicy.".into());
                    schema_obj
                }),
                "status": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::admissionregistration::v1::ValidatingAdmissionPolicyStatus>();
                    schema_obj.ensure_object().insert("description".into(), "status represents the current status of the ValidatingAdmissionPolicy, including warnings that are useful to determine if the policy behaves in the expected way. Populated by the system. Read-only.".into());
                    schema_obj
                }),
            },
            "required": [
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "spec".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::admissionregistration::v1::ValidatingAdmissionPolicySpec>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("spec defines the desired behavior of the ValidatingAdmissionPolicy.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
                    ...
                    (
                        "status".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::admissionregistration::v1::ValidatingAdmissionPolicyStatus>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("status represents the current status of the ValidatingAdmissionPolicy, including warnings that are useful to determine if the policy behaves in the expected way. Populated by the system. Read-only.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
