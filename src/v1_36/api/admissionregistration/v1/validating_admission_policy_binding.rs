...
pub struct ValidatingAdmissionPolicyBinding {
    ...
    pub spec: crate::api::admissionregistration::v1::ValidatingAdmissionPolicyBindingSpec,
}
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "spec": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "spec defines the desired behavior of the ValidatingAdmissionPolicyBinding.".into());
                    schema_obj
                }),
            },
            "required": [
                ...
                properties: [
                    ...
                    (
                        "spec".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("spec defines the desired behavior of the ValidatingAdmissionPolicyBinding.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
