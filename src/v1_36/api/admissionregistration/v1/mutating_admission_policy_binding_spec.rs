// Generated from definition io.k8s.api.admissionregistration.v1.MutatingAdmissionPolicyBindingSpec
...
impl crate::schemars::JsonSchema for MutatingAdmissionPolicyBindingSpec {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.admissionregistration.v1.MutatingAdmissionPolicyBindingSpec".into()
    }

    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            "description": "MutatingAdmissionPolicyBindingSpec defines the specification of the MutatingAdmissionPolicyBinding.",
            "type": "object",
            "properties": {
                "matchResources": ({
                ...
                "paramRef": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::admissionregistration::v1::ParamRef>();
    ...
    fn json_schema(__gen: &mut crate::schemars08::gen::SchemaGenerator) -> crate::schemars08::schema::Schema {
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                description: Some("MutatingAdmissionPolicyBindingSpec defines the specification of the MutatingAdmissionPolicyBinding.".into()),
                ..Default::default()
            })),
