...
impl crate::schemars::JsonSchema for SelfSubjectAccessReview {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.authorization.v1.SelfSubjectAccessReview".into()
    }
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "metadata": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "metadata is the standard list metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata".into());
                    schema_obj
                }),
                "spec": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::authorization::v1::SelfSubjectAccessReviewSpec>();
                    schema_obj.ensure_object().insert("description".into(), "spec holds information about the request being evaluated.  user and groups must be empty".into());
                    schema_obj
                }),
                "status": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::authorization::v1::SubjectAccessReviewStatus>();
                    schema_obj.ensure_object().insert("description".into(), "status is filled in by the server and indicates whether the request is allowed or not".into());
                    schema_obj
                }),
            },
            "required": [
...
impl crate::schemars08::JsonSchema for SelfSubjectAccessReview {
    ...
    fn json_schema(__gen: &mut crate::schemars08::gen::SchemaGenerator) -> crate::schemars08::schema::Schema {
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                description: Some("SelfSubjectAccessReview checks whether or the current user can perform an action.  Not filling in a spec.namespace means \"in all namespaces\".  Self is a special case, because users should always be able to check whether they can perform an action".into()),
                ..Default::default()
            })),
                ...
                properties: [
                    ...
                    (
                        "metadata".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("metadata is the standard list metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata".into()),
                                ..Default::default()
                            }));
                    ...
                    (
                        "spec".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("spec holds information about the request being evaluated.  user and groups must be empty".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
