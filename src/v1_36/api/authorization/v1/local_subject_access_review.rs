        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "spec": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "spec holds information about the request being evaluated.  spec.namespace must be equal to the namespace you made the request against.  If empty, it is defaulted.".into());
                    schema_obj
                }),
                "status": ({
...
impl crate::schemars08::JsonSchema for LocalSubjectAccessReview {
