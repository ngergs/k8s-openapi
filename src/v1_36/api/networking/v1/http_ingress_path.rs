        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                "backend": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "backend defines the referenced service endpoint to which the traffic will be forwarded to.".into());
                    schema_obj
                }),
                "path": {
...
impl crate::schemars08::JsonSchema for HTTPIngressPath {
