// Generated from definition io.k8s.api.networking.v1.ServiceCIDR
...
pub struct ServiceCIDR {
    ...
    pub spec: Option<crate::api::networking::v1::ServiceCIDRSpec>,

    /// status represents the current state of the ServiceCIDR. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    pub status: Option<crate::api::networking::v1::ServiceCIDRStatus>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::api::networking::v1::ServiceCIDRSpec> = None;
                let mut value_status: Option<crate::api::networking::v1::ServiceCIDRStatus> = None;
...
impl crate::schemars::JsonSchema for ServiceCIDR {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.networking.v1.ServiceCIDR".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "spec": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::networking::v1::ServiceCIDRSpec>();
                ...
                "status": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::networking::v1::ServiceCIDRStatus>();
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "spec".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::networking::v1::ServiceCIDRSpec>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                    ...
                    (
                        "status".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::networking::v1::ServiceCIDRStatus>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
