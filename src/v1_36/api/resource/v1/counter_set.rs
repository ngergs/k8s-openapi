// Generated from definition io.k8s.api.resource.v1.CounterSet
...
pub struct CounterSet {
    ...
    pub counters: std::collections::BTreeMap<std::string::String, crate::api::resource::v1::Counter>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_counters: Option<std::collections::BTreeMap<std::string::String, crate::api::resource::v1::Counter>> = None;
...
impl crate::schemars::JsonSchema for CounterSet {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.resource.v1.CounterSet".into()
    }
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                "counters": {
                    ...
                    "type": "object",
                    "additionalProperties": (__gen.subschema_for::<crate::api::resource::v1::Counter>()),
                },
                "name": {
...
impl crate::schemars08::JsonSchema for CounterSet {
                ...
                properties: [
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::Object))),
                            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                                additional_properties: Some(std::boxed::Box::new(__gen.subschema_for::<crate::api::resource::v1::Counter>())),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
