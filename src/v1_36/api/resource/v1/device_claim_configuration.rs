...
impl crate::schemars::JsonSchema for DeviceClaimConfiguration {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.resource.v1.DeviceClaimConfiguration".into()
    }
...
impl crate::schemars08::JsonSchema for DeviceClaimConfiguration {
