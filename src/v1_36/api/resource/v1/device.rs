// Generated from definition io.k8s.api.resource.v1.Device
...
pub struct Device {
    ...
    pub attributes: Option<std::collections::BTreeMap<std::string::String, crate::api::resource::v1::DeviceAttribute>>,
    ...
    ///
    /// The maximum number of attributes and capacities combined is 32.
    pub capacity: Option<std::collections::BTreeMap<std::string::String, crate::api::resource::v1::DeviceCapacity>>,
    ...
    pub consumes_counters: Option<std::vec::Vec<crate::api::resource::v1::DeviceCounterConsumption>>,
    ...
    pub node_allocatable_resource_mappings: Option<std::collections::BTreeMap<std::string::String, crate::api::resource::v1::NodeAllocatableResourceMapping>>,
    ...
    pub taints: Option<std::vec::Vec<crate::api::resource::v1::DeviceTaint>>,
}
...
impl crate::DeepMerge for Device {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::merge_strategies::map::granular(&mut self.node_allocatable_resource_mappings, other.node_allocatable_resource_mappings, |current_item, other_item| {
            crate::DeepMerge::merge_from(current_item, other_item);
        });
...
impl<'de> crate::serde::Deserialize<'de> for Device {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        enum Field {
            ...
            Key_name,
            Key_node_allocatable_resource_mappings,
            Key_node_name,
            Key_node_selector,
            Key_taints,
            Other,
                ...
                impl crate::serde::de::Visitor<'_> for Visitor {
                    ...
                    fn visit_str<E>(self, v: &str) -> Result<Self::Value, E> where E: crate::serde::de::Error {
                        Ok(match v {
                            ...
                            "name" => Field::Key_name,
                            "nodeAllocatableResourceMappings" => Field::Key_node_allocatable_resource_mappings,
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_attributes: Option<std::collections::BTreeMap<std::string::String, crate::api::resource::v1::DeviceAttribute>> = None;
                ...
                let mut value_capacity: Option<std::collections::BTreeMap<std::string::String, crate::api::resource::v1::DeviceCapacity>> = None;
                let mut value_consumes_counters: Option<std::vec::Vec<crate::api::resource::v1::DeviceCounterConsumption>> = None;
                let mut value_name: Option<std::string::String> = None;
                let mut value_node_allocatable_resource_mappings: Option<std::collections::BTreeMap<std::string::String, crate::api::resource::v1::NodeAllocatableResourceMapping>> = None;
                ...
                let mut value_taints: Option<std::vec::Vec<crate::api::resource::v1::DeviceTaint>> = None;
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_node_allocatable_resource_mappings => value_node_allocatable_resource_mappings = crate::serde::de::MapAccess::next_value(&mut map)?,
                ...
                Ok(Device {
                    ...
                    node_allocatable_resource_mappings: value_node_allocatable_resource_mappings,
...
impl crate::serde::Serialize for Device {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        let mut state = serializer.serialize_struct(
            ...
            self.node_allocatable_resource_mappings.as_ref().map_or(0, |_| 1) +
        ...
        if let Some(value) = &self.node_allocatable_resource_mappings {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "nodeAllocatableResourceMappings", value)?;
        }
...
impl crate::schemars::JsonSchema for Device {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.resource.v1.Device".into()
    }
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "attributes": {
                    ...
                    "type": "object",
                    "additionalProperties": (__gen.subschema_for::<crate::api::resource::v1::DeviceAttribute>()),
                },
                "bindingConditions": {
                ...
                "capacity": {
                    ...
                    "type": "object",
                    "additionalProperties": (__gen.subschema_for::<crate::api::resource::v1::DeviceCapacity>()),
                },
                "consumesCounters": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::resource::v1::DeviceCounterConsumption>()),
                },
                "name": {
                ...
                "nodeAllocatableResourceMappings": {
                    ...
                    "type": "object",
                    "additionalProperties": (__gen.subschema_for::<crate::api::resource::v1::NodeAllocatableResourceMapping>()),
                },
                "nodeName": {
                ...
                "taints": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::resource::v1::DeviceTaint>()),
                },
            },
            "required": [
                "name",
...
impl crate::schemars08::JsonSchema for Device {
                ...
                properties: [
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::Object))),
                            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                                additional_properties: Some(std::boxed::Box::new(__gen.subschema_for::<crate::api::resource::v1::DeviceAttribute>())),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("BindingConditions defines the conditions for proceeding with binding. All of these conditions must be set in the per-device status conditions with a value of True to proceed with binding the pod to the node while scheduling the pod.\n\nThe maximum number of binding conditions is 4.\n\nThe conditions must be a valid condition type string.\n\nThis is a beta field and requires enabling the DRADeviceBindingConditions and DRAResourceClaimDeviceStatus feature gates.".into()),
                                ..Default::default()
                            })),
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("BindingFailureConditions defines the conditions for binding failure. They may be set in the per-device status conditions. If any is set to \"True\", a binding failure occurred.\n\nThe maximum number of binding failure conditions is 4.\n\nThe conditions must be a valid condition type string.\n\nThis is a beta field and requires enabling the DRADeviceBindingConditions and DRAResourceClaimDeviceStatus feature gates.".into()),
                                ..Default::default()
                            })),
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::Array))),
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::Object))),
                            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                                additional_properties: Some(std::boxed::Box::new(__gen.subschema_for::<crate::api::resource::v1::DeviceCapacity>())),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::Array))),
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::resource::v1::DeviceCounterConsumption>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("NodeAllocatableResourceMappings defines the mapping of node resources that are managed by the DRA driver exposing this device. This includes resources currently reported in v1.Node `status.allocatable` that are not extended resources (see https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/#extended-resources). Examples include \"cpu\", \"memory\", \"ephemeral-storage\", and hugepages. In addition to standard requests made through the Pod `spec`, these resources can also be requested through claims and allocated by the DRA driver. For example, a CPU DRA driver might allocate exclusive CPUs or auxiliary node memory dependencies of an accelerator device. The keys of this map are the node-allocatable resource names (e.g., \"cpu\", \"memory\"). Extended resource names are not permitted as keys.".into()),
                                ..Default::default()
                            })),
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::Object))),
                            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                                additional_properties: Some(std::boxed::Box::new(__gen.subschema_for::<crate::api::resource::v1::NodeAllocatableResourceMapping>())),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::Array))),
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::resource::v1::DeviceTaint>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
