// Generated from definition io.k8s.api.resource.v1.ResourceClaimStatus

/// ResourceClaimStatus tracks whether the resource has been allocated and what the result of that was.
#[derive(Clone, Debug, Default, PartialEq, fake::Dummy)]
pub struct ResourceClaimStatus {
    /// Allocation is set once the claim has been allocated successfully.
    pub allocation: Option<crate::api::resource::v1::AllocationResult>,

    /// Devices contains the status of each device allocated for this claim, as reported by the driver. This can include driver-specific information. Entries are owned by their respective drivers.
    pub devices: Option<std::vec::Vec<crate::api::resource::v1::AllocatedDeviceStatus>>,
    ...
    pub reserved_for: Option<std::vec::Vec<crate::api::resource::v1::ResourceClaimConsumerReference>>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_allocation: Option<crate::api::resource::v1::AllocationResult> = None;
                let mut value_devices: Option<std::vec::Vec<crate::api::resource::v1::AllocatedDeviceStatus>> = None;
                let mut value_reserved_for: Option<std::vec::Vec<crate::api::resource::v1::ResourceClaimConsumerReference>> = None;
...
impl crate::schemars::JsonSchema for ResourceClaimStatus {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.resource.v1.ResourceClaimStatus".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                "allocation": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1::AllocationResult>();
                ...
                "devices": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::resource::v1::AllocatedDeviceStatus>()),
                },
                "reservedFor": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::resource::v1::ResourceClaimConsumerReference>()),
                },
            },
        })
    }
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    (
                        "allocation".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1::AllocationResult>().into_object();
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::resource::v1::AllocatedDeviceStatus>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::Array))),
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::resource::v1::ResourceClaimConsumerReference>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
