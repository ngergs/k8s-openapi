// Generated from definition io.k8s.api.resource.v1.ResourceSliceSpec
...
pub struct ResourceSliceSpec {
    ...
    pub devices: Option<std::vec::Vec<crate::api::resource::v1::Device>>,
    ...
    pub pool: crate::api::resource::v1::ResourcePool,
    ...
    pub shared_counters: Option<std::vec::Vec<crate::api::resource::v1::CounterSet>>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_devices: Option<std::vec::Vec<crate::api::resource::v1::Device>> = None;
                ...
                let mut value_pool: Option<crate::api::resource::v1::ResourcePool> = None;
                let mut value_shared_counters: Option<std::vec::Vec<crate::api::resource::v1::CounterSet>> = None;
...
impl crate::schemars::JsonSchema for ResourceSliceSpec {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.resource.v1.ResourceSliceSpec".into()
    }
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "devices": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::resource::v1::Device>()),
                },
                "driver": {
                ...
                "pool": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1::ResourcePool>();
                ...
                "sharedCounters": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::resource::v1::CounterSet>()),
                },
            },
            "required": [
                "driver",
...
impl crate::schemars08::JsonSchema for ResourceSliceSpec {
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("Devices lists some or all of the devices in this pool.\n\nMust not have more than 128 entries. If any device uses taints or consumes counters the limit is 64.\n\nOnly one of Devices and SharedCounters can be set in a ResourceSlice.".into()),
                                ..Default::default()
                            })),
                            ...
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::resource::v1::Device>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
                    ...
                    (
                        "pool".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1::ResourcePool>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("SharedCounters defines a list of counter sets, each of which has a name and a list of counters available.\n\nThe names of the counter sets must be unique in the ResourcePool.\n\nOnly one of Devices and SharedCounters can be set in a ResourceSlice.\n\nThe maximum number of counter sets is 8.".into()),
                                ..Default::default()
                            })),
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::Array))),
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::resource::v1::CounterSet>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
