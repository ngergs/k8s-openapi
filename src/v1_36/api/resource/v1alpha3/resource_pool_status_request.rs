...
pub struct ResourcePoolStatusRequest {
    ...
    pub spec: crate::api::resource::v1alpha3::ResourcePoolStatusRequestSpec,
    ...
    pub status: Option<crate::api::resource::v1alpha3::ResourcePoolStatusRequestStatus>,
}
...
impl crate::ListableResource for ResourcePoolStatusRequest {
    const LIST_KIND: &'static str = "ResourcePoolStatusRequestList";
}
...
impl crate::DeepMerge for ResourcePoolStatusRequest {
...
impl<'de> crate::serde::Deserialize<'de> for ResourcePoolStatusRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            type Value = ResourcePoolStatusRequest;
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::api::resource::v1alpha3::ResourcePoolStatusRequestSpec> = None;
                let mut value_status: Option<crate::api::resource::v1alpha3::ResourcePoolStatusRequestStatus> = None;
...
impl crate::serde::Serialize for ResourcePoolStatusRequest {
...
impl crate::schemars::JsonSchema for ResourcePoolStatusRequest {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.resource.v1alpha3.ResourcePoolStatusRequest".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "spec": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1alpha3::ResourcePoolStatusRequestSpec>();
                    schema_obj.ensure_object().insert("description".into(), "Spec defines the filters for which pools to include in the status. The spec is immutable once created.".into());
                    schema_obj
                }),
                "status": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1alpha3::ResourcePoolStatusRequestStatus>();
                    schema_obj.ensure_object().insert("description".into(), "Status is populated by the controller with the calculated pool status. When status is non-nil, the request is considered complete and the entire object becomes immutable.".into());
                    schema_obj
                }),
            },
            "required": [
...
impl crate::schemars08::JsonSchema for ResourcePoolStatusRequest {
    ...
    fn json_schema(__gen: &mut crate::schemars08::gen::SchemaGenerator) -> crate::schemars08::schema::Schema {
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                description: Some("ResourcePoolStatusRequest triggers a one-time calculation of resource pool status based on the provided filters. Once status is set, the request is considered complete and will not be reprocessed. Users should delete and recreate requests to get updated information.".into()),
                ..Default::default()
            })),
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "spec".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1alpha3::ResourcePoolStatusRequestSpec>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("Spec defines the filters for which pools to include in the status. The spec is immutable once created.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
                    ...
                    (
                        "status".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1alpha3::ResourcePoolStatusRequestStatus>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("Status is populated by the controller with the calculated pool status. When status is non-nil, the request is considered complete and the entire object becomes immutable.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
