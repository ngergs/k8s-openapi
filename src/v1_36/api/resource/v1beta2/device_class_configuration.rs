// Generated from definition io.k8s.api.resource.v1beta2.DeviceClassConfiguration
...
impl crate::schemars::JsonSchema for DeviceClassConfiguration {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.resource.v1beta2.DeviceClassConfiguration".into()
    }
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    (
                        "opaque".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1beta2::OpaqueDeviceConfiguration>().into_object();
