// Generated from definition io.k8s.api.resource.v1beta2.DeviceTaintRule
...
pub struct DeviceTaintRule {
    ...
    pub spec: crate::api::resource::v1beta2::DeviceTaintRuleSpec,

    /// Status provides information about what was requested in the spec.
    pub status: Option<crate::api::resource::v1beta2::DeviceTaintRuleStatus>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::api::resource::v1beta2::DeviceTaintRuleSpec> = None;
                let mut value_status: Option<crate::api::resource::v1beta2::DeviceTaintRuleStatus> = None;
...
impl crate::schemars::JsonSchema for DeviceTaintRule {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.resource.v1beta2.DeviceTaintRule".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "spec": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1beta2::DeviceTaintRuleSpec>();
                ...
                "status": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1beta2::DeviceTaintRuleStatus>();
                    schema_obj.ensure_object().insert("description".into(), "Status provides information about what was requested in the spec.".into());
                    schema_obj
                }),
            },
            "required": [
...
impl crate::schemars08::JsonSchema for DeviceTaintRule {
    ...
    fn json_schema(__gen: &mut crate::schemars08::gen::SchemaGenerator) -> crate::schemars08::schema::Schema {
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                description: Some("DeviceTaintRule adds one taint to all devices which match the selector. This has the same effect as if the taint was specified directly in the ResourceSlice by the DRA driver.".into()),
                ..Default::default()
            })),
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "spec".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1beta2::DeviceTaintRuleSpec>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("Spec specifies the selector and one taint.\n\nChanging the spec automatically increments the metadata.generation number.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
                    ...
                    (
                        "status".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1beta2::DeviceTaintRuleStatus>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("Status provides information about what was requested in the spec.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
