// Generated from definition io.k8s.api.resource.v1beta2.DeviceTaintRuleSpec
...
pub struct DeviceTaintRuleSpec {
    ...
    pub device_selector: Option<crate::api::resource::v1beta2::DeviceTaintSelector>,

    /// The taint that gets applied to matching devices.
    pub taint: crate::api::resource::v1beta2::DeviceTaint,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_device_selector: Option<crate::api::resource::v1beta2::DeviceTaintSelector> = None;
                let mut value_taint: Option<crate::api::resource::v1beta2::DeviceTaint> = None;
...
impl crate::schemars::JsonSchema for DeviceTaintRuleSpec {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.resource.v1beta2.DeviceTaintRuleSpec".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                "deviceSelector": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1beta2::DeviceTaintSelector>();
                    schema_obj.ensure_object().insert("description".into(), "DeviceSelector defines which device(s) the taint is applied to. All selector criteria must be satisfied for a device to match. The empty selector matches all devices. Without a selector, no devices are matches.".into());
                    schema_obj
                }),
                "taint": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1beta2::DeviceTaint>();
                    schema_obj.ensure_object().insert("description".into(), "The taint that gets applied to matching devices.".into());
                    schema_obj
                }),
            },
            "required": [
...
impl crate::schemars08::JsonSchema for DeviceTaintRuleSpec {
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    (
                        "deviceSelector".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1beta2::DeviceTaintSelector>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("DeviceSelector defines which device(s) the taint is applied to. All selector criteria must be satisfied for a device to match. The empty selector matches all devices. Without a selector, no devices are matches.".into()),
                                ..Default::default()
                            }));
                    ...
                    (
                        "taint".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1beta2::DeviceTaint>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
