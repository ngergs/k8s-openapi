...
pub struct ResourceSliceSpec {
    ...
    pub devices: Option<std::vec::Vec<crate::api::resource::v1beta2::Device>>,
    ...
    pub pool: crate::api::resource::v1beta2::ResourcePool,
    ...
    pub shared_counters: Option<std::vec::Vec<crate::api::resource::v1beta2::CounterSet>>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_devices: Option<std::vec::Vec<crate::api::resource::v1beta2::Device>> = None;
                ...
                let mut value_pool: Option<crate::api::resource::v1beta2::ResourcePool> = None;
                let mut value_shared_counters: Option<std::vec::Vec<crate::api::resource::v1beta2::CounterSet>> = None;
...
impl crate::schemars::JsonSchema for ResourceSliceSpec {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.resource.v1beta2.ResourceSliceSpec".into()
    }
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "devices": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::resource::v1beta2::Device>()),
                },
                "driver": {
                ...
                "pool": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1beta2::ResourcePool>();
                ...
                "sharedCounters": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::resource::v1beta2::CounterSet>()),
                },
            },
            "required": [
                "driver",
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::resource::v1beta2::Device>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
                    ...
                    (
                        "pool".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1beta2::ResourcePool>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::Array))),
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::resource::v1beta2::CounterSet>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
