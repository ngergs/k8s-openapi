...
pub struct StorageVersion {
    ...
    pub spec: Option<crate::api::apiserverinternal::v1alpha1::StorageVersionSpec>,
    ...
    pub status: Option<crate::api::apiserverinternal::v1alpha1::StorageVersionStatus>,
}
...
impl crate::schemars::JsonSchema for StorageVersion {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.apiserverinternal.v1alpha1.StorageVersion".into()
    }
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "metadata": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "metadata is the standard object metadata. The name is <group>.<resource>.".into());
                    schema_obj
                }),
                "spec": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::apiserverinternal::v1alpha1::StorageVersionSpec>();
                    schema_obj.ensure_object().insert("description".into(), "spec is an empty spec. It is here to comply with Kubernetes API style.".into());
                    schema_obj
                }),
                "status": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::apiserverinternal::v1alpha1::StorageVersionStatus>();
                    schema_obj.ensure_object().insert("description".into(), "status on the version the API server instance can decode from and encode objects to when persisting objects in the backend.".into());
                    schema_obj
                }),
            },
            "required": [
...
impl crate::schemars08::JsonSchema for StorageVersion {
    ...
    fn json_schema(__gen: &mut crate::schemars08::gen::SchemaGenerator) -> crate::schemars08::schema::Schema {
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                description: Some("Storage version of a specific resource.".into()),
                ..Default::default()
            })),
                ...
                properties: [
                    ...
                    (
                        "metadata".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("metadata is the standard object metadata. The name is <group>.<resource>.".into()),
                                ..Default::default()
                            }));
                    ...
                    (
                        "spec".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("spec is an empty spec. It is here to comply with Kubernetes API style.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
                    ...
                    (
                        "status".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("status on the version the API server instance can decode from and encode objects to when persisting objects in the backend.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
