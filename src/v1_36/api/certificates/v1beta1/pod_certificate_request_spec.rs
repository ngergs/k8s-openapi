...
pub struct PodCertificateRequestSpec {
    ...
    pub pkix_public_key: Option<crate::ByteString>,
    ...
    pub proof_of_possession: Option<crate::ByteString>,
    ...
    ///
    /// Signer implementations do not need to support all key types supported by kube-apiserver and kubelet.  If a signer does not support the key type used for a given PodCertificateRequest, it must deny the request by setting a status.conditions entry with a type of "Denied" and a reason of "UnsupportedKeyType". It may also suggest a key type that it does support in the message field.
    pub stub_pkc_s10_request: crate::ByteString,
...
impl crate::DeepMerge for PodCertificateRequestSpec {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::DeepMerge::merge_from(&mut self.stub_pkc_s10_request, other.stub_pkc_s10_request);
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
                ...
                impl crate::serde::de::Visitor<'_> for Visitor {
                    ...
                    fn visit_str<E>(self, v: &str) -> Result<Self::Value, E> where E: crate::serde::de::Error {
                        Ok(match v {
                            ...
                            "stubPKCS10Request" => Field::Key_stub_pkc_s10_request,
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_stub_pkc_s10_request: Option<crate::ByteString> = None;
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_stub_pkc_s10_request => value_stub_pkc_s10_request = crate::serde::de::MapAccess::next_value(&mut map)?,
                ...
                Ok(PodCertificateRequestSpec {
                    ...
                    pkix_public_key: value_pkix_public_key,
                    pod_name: value_pod_name.unwrap_or_default(),
                    pod_uid: value_pod_uid.unwrap_or_default(),
                    proof_of_possession: value_proof_of_possession,
                    ...
                    stub_pkc_s10_request: value_stub_pkc_s10_request.unwrap_or_default(),
...
impl crate::serde::Serialize for PodCertificateRequestSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        let mut state = serializer.serialize_struct(
            ...
            self.pkix_public_key.as_ref().map_or(0, |_| 1) +
            self.proof_of_possession.as_ref().map_or(0, |_| 1) +
        ...
        if let Some(value) = &self.pkix_public_key {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "pkixPublicKey", value)?;
        }
        ...
        if let Some(value) = &self.proof_of_possession {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "proofOfPossession", value)?;
        }
        ...
        crate::serde::ser::SerializeStruct::serialize_field(&mut state, "stubPKCS10Request", &self.stub_pkc_s10_request)?;
        ...
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "stubPKCS10Request".into(),
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("A PKCS#10 certificate signing request (DER-serialized) generated by Kubelet using the subject private key.\n\nMost signer implementations will ignore the contents of the CSR except to extract the subject public key. The API server automatically verifies the CSR signature during admission, so the signer does not need to repeat the verification.  CSRs generated by kubelet are completely empty.\n\nThe subject public key must be one of RSA3072, RSA4096, ECDSAP256, ECDSAP384, ECDSAP521, or ED25519. Note that this list may be expanded in the future.\n\nSigner implementations do not need to support all key types supported by kube-apiserver and kubelet.  If a signer does not support the key type used for a given PodCertificateRequest, it must deny the request by setting a status.conditions entry with a type of \"Denied\" and a reason of \"UnsupportedKeyType\". It may also suggest a key type that it does support in the message field.".into()),
                                ..Default::default()
                            })),
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::String))),
                            format: Some("byte".into()),
