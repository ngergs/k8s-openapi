// Generated from definition io.k8s.api.scheduling.v1alpha2.WorkloadSpec
...
pub struct WorkloadSpec {
    ...
    pub controller_ref: Option<crate::api::scheduling::v1alpha2::TypedLocalObjectReference>,
    ...
    pub pod_group_templates: std::vec::Vec<crate::api::scheduling::v1alpha2::PodGroupTemplate>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_controller_ref: Option<crate::api::scheduling::v1alpha2::TypedLocalObjectReference> = None;
                let mut value_pod_group_templates: Option<std::vec::Vec<crate::api::scheduling::v1alpha2::PodGroupTemplate>> = None;
                ...
                Ok(WorkloadSpec {
                    ...
                    pod_group_templates: value_pod_group_templates.unwrap_or_default(),
                })
            }
        }
...
impl crate::serde::Serialize for WorkloadSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        crate::serde::ser::SerializeStruct::serialize_field(&mut state, "podGroupTemplates", &self.pod_group_templates)?;
...
impl crate::schemars::JsonSchema for WorkloadSpec {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.scheduling.v1alpha2.WorkloadSpec".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                "controllerRef": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1alpha2::TypedLocalObjectReference>();
                ...
                "podGroupTemplates": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::scheduling::v1alpha2::PodGroupTemplate>()),
                },
            },
            "required": [
                "podGroupTemplates",
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    (
                        "controllerRef".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1alpha2::TypedLocalObjectReference>().into_object();
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("PodGroupTemplates is the list of templates that make up the Workload. The maximum number of templates is 8. This field is immutable.".into()),
                                ..Default::default()
                            })),
                            ...
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::scheduling::v1alpha2::PodGroupTemplate>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
