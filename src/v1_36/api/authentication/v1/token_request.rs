...
pub struct TokenRequest {
    ...
    pub spec: Option<crate::api::authentication::v1::TokenRequestSpec>,
...
impl crate::schemars::JsonSchema for TokenRequest {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.authentication.v1.TokenRequest".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "spec": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::authentication::v1::TokenRequestSpec>();
                    schema_obj.ensure_object().insert("description".into(), "spec holds information about the request being evaluated".into());
                    schema_obj
                }),
                "status": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::authentication::v1::TokenRequestStatus>();
                    schema_obj.ensure_object().insert("description".into(), "status is filled in by the server and indicates whether the token can be authenticated.".into());
                    schema_obj
                }),
            },
            "required": [
...
impl crate::schemars08::JsonSchema for TokenRequest {
    ...
    fn json_schema(__gen: &mut crate::schemars08::gen::SchemaGenerator) -> crate::schemars08::schema::Schema {
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                description: Some("TokenRequest requests a token for a given service account.".into()),
                ..Default::default()
            })),
                ...
                properties: [
                    ...
                    (
                        "status".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("status is filled in by the server and indicates whether the token can be authenticated.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
