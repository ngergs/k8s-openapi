        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                "userInfo": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "userInfo is a set of attributes belonging to the user making this request.".into());
                    schema_obj
                }),
            },
        })
...
impl crate::schemars08::JsonSchema for SelfSubjectReviewStatus {
                    ...
                    (
                        "userInfo".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("userInfo is a set of attributes belonging to the user making this request.".into()),
                                ..Default::default()
                            }));
