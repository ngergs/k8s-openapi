        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                "conditions": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::autoscaling::v2::HorizontalPodAutoscalerCondition>()),
                },
                "currentMetrics": {
                    "description": "currentMetrics is the last read state of the metrics used by this autoscaler.",
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::autoscaling::v2::MetricStatus>()),
                },
                "currentReplicas": {
                ...
                "lastScaleTime": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "lastScaleTime is the last time the HorizontalPodAutoscaler scaled the number of pods, used by the autoscaler to control how often the number of pods is changed.".into());
                    schema_obj
                }),
                "observedGeneration": {
...
impl crate::schemars08::JsonSchema for HorizontalPodAutoscalerStatus {
                ...
                properties: [
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::autoscaling::v2::HorizontalPodAutoscalerCondition>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::Array))),
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::autoscaling::v2::MetricStatus>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
