...
pub struct ListMeta {
    ...
    pub shard_info: Option<crate::apimachinery::pkg::apis::meta::v1::ShardInfo>,
}
...
impl crate::DeepMerge for ListMeta {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::DeepMerge::merge_from(&mut self.shard_info, other.shard_info);
    }
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
                ...
                impl crate::serde::de::Visitor<'_> for Visitor {
                    ...
                    fn visit_str<E>(self, v: &str) -> Result<Self::Value, E> where E: crate::serde::de::Error {
                        Ok(match v {
                            ...
                            "shardInfo" => Field::Key_shard_info,
                            _ => Field::Other,
                        })
                    }
                }
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_shard_info: Option<crate::apimachinery::pkg::apis::meta::v1::ShardInfo> = None;
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_shard_info => value_shard_info = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for ListMeta {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        let mut state = serializer.serialize_struct(
            ...
            self.shard_info.as_ref().map_or(0, |_| 1),
        )?;
        ...
        if let Some(value) = &self.shard_info {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "shardInfo", value)?;
        }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "shardInfo": ({
                    let mut schema_obj = __gen.subschema_for::<crate::apimachinery::pkg::apis::meta::v1::ShardInfo>();
                    schema_obj.ensure_object().insert("description".into(), "shardInfo is set when the list is a filtered subset of the full collection, as selected by a shard selector on the request. It echoes back the selector so clients can verify which shard they received and merge sharded responses. Clients should not cache sharded list responses as a full representation of the collection.\n\nThis is an alpha field and requires enabling the ShardedListAndWatch feature gate.".into());
                    schema_obj
                }),
            },
        })
...
impl crate::schemars08::JsonSchema for ListMeta {
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "shardInfo".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::apimachinery::pkg::apis::meta::v1::ShardInfo>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("shardInfo is set when the list is a filtered subset of the full collection, as selected by a shard selector on the request. It echoes back the selector so clients can verify which shard they received and merge sharded responses. Clients should not cache sharded list responses as a full representation of the collection.\n\nThis is an alpha field and requires enabling the ShardedListAndWatch feature gate.".into()),
                                ..Default::default()
                            }));
