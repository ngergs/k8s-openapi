...
pub struct ClusterRole {
    ...
    pub rules: Option<std::vec::Vec<crate::api::rbac::v1::PolicyRule>>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_rules: Option<std::vec::Vec<crate::api::rbac::v1::PolicyRule>> = None;
...
impl crate::schemars::JsonSchema for ClusterRole {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.rbac.v1.ClusterRole".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                "aggregationRule": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::rbac::v1::AggregationRule>();
                    schema_obj.ensure_object().insert("description".into(), "AggregationRule is an optional field that describes how to build the Rules for this ClusterRole. If AggregationRule is set, then the Rules are controller managed and direct changes to Rules will be stomped by the controller.".into());
                    schema_obj
                }),
                "apiVersion": {
                ...
                "rules": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::rbac::v1::PolicyRule>()),
                },
            },
            "required": [
                "metadata",
...
impl crate::schemars08::JsonSchema for ClusterRole {
    ...
    fn json_schema(__gen: &mut crate::schemars08::gen::SchemaGenerator) -> crate::schemars08::schema::Schema {
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                description: Some("ClusterRole is a cluster level, logical grouping of PolicyRules that can be referenced as a unit by a RoleBinding or ClusterRoleBinding.".into()),
                ..Default::default()
            })),
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    (
                        "aggregationRule".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("AggregationRule is an optional field that describes how to build the Rules for this ClusterRole. If AggregationRule is set, then the Rules are controller managed and direct changes to Rules will be stomped by the controller.".into()),
                                ..Default::default()
                            }));
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("Rules holds all the PolicyRules for this ClusterRole".into()),
                                ..Default::default()
                            })),
                            ...
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::rbac::v1::PolicyRule>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
