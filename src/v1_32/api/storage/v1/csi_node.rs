...
impl crate::schemars::JsonSchema for CSINode {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.storage.v1.CSINode".into()
    }
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "metadata": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "Standard object's metadata. metadata.name must be the Kubernetes node name.".into());
                    schema_obj
                }),
                "spec": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::storage::v1::CSINodeSpec>();
                    schema_obj.ensure_object().insert("description".into(), "spec is the specification of CSINode".into());
                    schema_obj
                }),
            },
            "required": [
...
impl crate::schemars08::JsonSchema for CSINode {
                ...
                properties: [
                    ...
                    (
                        "metadata".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("Standard object's metadata. metadata.name must be the Kubernetes node name.".into()),
                                ..Default::default()
                            }));
                    ...
                    (
                        "spec".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("spec is the specification of CSINode".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
