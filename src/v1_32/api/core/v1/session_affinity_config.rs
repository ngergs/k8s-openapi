...
impl crate::schemars::JsonSchema for SessionAffinityConfig {
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                "clientIP": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::core::v1::ClientIPConfig>();
                    schema_obj.ensure_object().insert("description".into(), "clientIP contains the configurations of Client IP based session affinity.".into());
                    schema_obj
                }),
            },
        })
...
impl crate::schemars08::JsonSchema for SessionAffinityConfig {
