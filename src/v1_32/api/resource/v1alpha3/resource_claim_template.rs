// Generated from definition io.k8s.api.resource.v1alpha3.ResourceClaimTemplate
...
pub struct ResourceClaimTemplate {
    ...
    pub spec: crate::api::resource::v1alpha3::ResourceClaimTemplateSpec,
}
...
impl crate::ListableResource for ResourceClaimTemplate {
...
impl crate::DeepMerge for ResourceClaimTemplate {
...
impl<'de> crate::serde::Deserialize<'de> for ResourceClaimTemplate {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            type Value = ResourceClaimTemplate;
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::api::resource::v1alpha3::ResourceClaimTemplateSpec> = None;
...
impl crate::serde::Serialize for ResourceClaimTemplate {
...
impl crate::schemars::JsonSchema for ResourceClaimTemplate {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.resource.v1alpha3.ResourceClaimTemplate".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "spec": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1alpha3::ResourceClaimTemplateSpec>();
                    schema_obj.ensure_object().insert("description".into(), "Describes the ResourceClaim that is to be generated.\n\nThis field is immutable. A ResourceClaim will get created by the control plane for a Pod when needed and then not get updated anymore.".into());
                    schema_obj
                }),
            },
            "required": [
...
impl crate::schemars08::JsonSchema for ResourceClaimTemplate {
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "spec".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1alpha3::ResourceClaimTemplateSpec>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("Describes the ResourceClaim that is to be generated.\n\nThis field is immutable. A ResourceClaim will get created by the control plane for a Pod when needed and then not get updated anymore.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
