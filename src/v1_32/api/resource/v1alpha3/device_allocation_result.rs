// Generated from definition io.k8s.api.resource.v1alpha3.DeviceAllocationResult
...
pub struct DeviceAllocationResult {
    ...
    pub config: Option<std::vec::Vec<crate::api::resource::v1alpha3::DeviceAllocationConfiguration>>,

    /// Results lists all allocated devices.
    pub results: Option<std::vec::Vec<crate::api::resource::v1alpha3::DeviceRequestAllocationResult>>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_config: Option<std::vec::Vec<crate::api::resource::v1alpha3::DeviceAllocationConfiguration>> = None;
                let mut value_results: Option<std::vec::Vec<crate::api::resource::v1alpha3::DeviceRequestAllocationResult>> = None;
...
impl crate::schemars::JsonSchema for DeviceAllocationResult {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.resource.v1alpha3.DeviceAllocationResult".into()
    }
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                "config": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::resource::v1alpha3::DeviceAllocationConfiguration>()),
                },
                "results": {
                    "description": "Results lists all allocated devices.",
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::resource::v1alpha3::DeviceRequestAllocationResult>()),
                },
            },
        })
    }
...
impl crate::schemars08::JsonSchema for DeviceAllocationResult {
                ...
                properties: [
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::resource::v1alpha3::DeviceAllocationConfiguration>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::Array))),
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::resource::v1alpha3::DeviceRequestAllocationResult>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
