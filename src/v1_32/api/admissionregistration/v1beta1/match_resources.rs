...
pub struct MatchResources {
    ...
    pub resource_rules: Option<std::vec::Vec<crate::api::admissionregistration::v1beta1::NamedRuleWithOperations>>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_exclude_resource_rules: Option<std::vec::Vec<crate::api::admissionregistration::v1beta1::NamedRuleWithOperations>> = None;
                ...
                let mut value_resource_rules: Option<std::vec::Vec<crate::api::admissionregistration::v1beta1::NamedRuleWithOperations>> = None;
...
impl crate::schemars::JsonSchema for MatchResources {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.admissionregistration.v1beta1.MatchResources".into()
    }
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                "excludeResourceRules": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::admissionregistration::v1beta1::NamedRuleWithOperations>()),
                },
                "matchPolicy": {
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::admissionregistration::v1beta1::NamedRuleWithOperations>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
