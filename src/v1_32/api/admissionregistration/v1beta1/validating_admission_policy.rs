// Generated from definition io.k8s.api.admissionregistration.v1beta1.ValidatingAdmissionPolicy
...
pub struct ValidatingAdmissionPolicy {
    ...
    pub spec: Option<crate::api::admissionregistration::v1beta1::ValidatingAdmissionPolicySpec>,

    /// The status of the ValidatingAdmissionPolicy, including warnings that are useful to determine if the policy behaves in the expected way. Populated by the system. Read-only.
    pub status: Option<crate::api::admissionregistration::v1beta1::ValidatingAdmissionPolicyStatus>,
}
...
impl crate::ListableResource for ValidatingAdmissionPolicy {
...
impl crate::DeepMerge for ValidatingAdmissionPolicy {
...
impl<'de> crate::serde::Deserialize<'de> for ValidatingAdmissionPolicy {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            type Value = ValidatingAdmissionPolicy;
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::api::admissionregistration::v1beta1::ValidatingAdmissionPolicySpec> = None;
                let mut value_status: Option<crate::api::admissionregistration::v1beta1::ValidatingAdmissionPolicyStatus> = None;
...
impl crate::serde::Serialize for ValidatingAdmissionPolicy {
...
impl crate::schemars::JsonSchema for ValidatingAdmissionPolicy {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.admissionregistration.v1beta1.ValidatingAdmissionPolicy".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "spec": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::admissionregistration::v1beta1::ValidatingAdmissionPolicySpec>();
                    schema_obj.ensure_object().insert("description".into(), "Specification of the desired behavior of the ValidatingAdmissionPolicy.".into());
                    schema_obj
                }),
                "status": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::admissionregistration::v1beta1::ValidatingAdmissionPolicyStatus>();
                    schema_obj.ensure_object().insert("description".into(), "The status of the ValidatingAdmissionPolicy, including warnings that are useful to determine if the policy behaves in the expected way. Populated by the system. Read-only.".into());
                    schema_obj
                }),
            },
            "required": [
...
impl crate::schemars08::JsonSchema for ValidatingAdmissionPolicy {
    ...
    fn json_schema(__gen: &mut crate::schemars08::gen::SchemaGenerator) -> crate::schemars08::schema::Schema {
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                description: Some("ValidatingAdmissionPolicy describes the definition of an admission validation policy that accepts or rejects an object without changing it.".into()),
                ..Default::default()
            })),
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "spec".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::admissionregistration::v1beta1::ValidatingAdmissionPolicySpec>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("Specification of the desired behavior of the ValidatingAdmissionPolicy.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
                    ...
                    (
                        "status".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::admissionregistration::v1beta1::ValidatingAdmissionPolicyStatus>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("The status of the ValidatingAdmissionPolicy, including warnings that are useful to determine if the policy behaves in the expected way. Populated by the system. Read-only.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
