// Generated from definition io.k8s.api.flowcontrol.v1.PolicyRulesWithSubjects
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                "nonResourceRules": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::flowcontrol::v1::NonResourcePolicyRule>()),
                },
                "resourceRules": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::flowcontrol::v1::ResourcePolicyRule>()),
                },
                "subjects": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::flowcontrol::v1::Subject>()),
                },
            },
            "required": [
                "subjects",
...
impl crate::schemars08::JsonSchema for PolicyRulesWithSubjects {
                ...
                properties: [
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::flowcontrol::v1::NonResourcePolicyRule>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::Array))),
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::flowcontrol::v1::ResourcePolicyRule>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::Array))),
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::flowcontrol::v1::Subject>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
