...
pub struct DeviceRequest {
    ...
    pub exactly: Option<crate::api::resource::v1::ExactDeviceRequest>,
    ...
    pub first_available: Option<std::vec::Vec<crate::api::resource::v1::DeviceSubRequest>>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_exactly: Option<crate::api::resource::v1::ExactDeviceRequest> = None;
                let mut value_first_available: Option<std::vec::Vec<crate::api::resource::v1::DeviceSubRequest>> = None;
...
impl crate::schemars::JsonSchema for DeviceRequest {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.resource.v1.DeviceRequest".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                "exactly": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1::ExactDeviceRequest>();
                ...
                "firstAvailable": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::resource::v1::DeviceSubRequest>()),
                },
                "name": {
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    (
                        "exactly".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1::ExactDeviceRequest>().into_object();
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::resource::v1::DeviceSubRequest>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
