// Generated from definition io.k8s.api.resource.v1beta2.DeviceSelector

/// DeviceSelector must have exactly one field set.
#[derive(Clone, Debug, Default, PartialEq, fake::Dummy)]
pub struct DeviceSelector {
    /// CEL contains a CEL expression for selecting a device.
    pub cel: Option<crate::api::resource::v1beta2::CELDeviceSelector>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_cel: Option<crate::api::resource::v1beta2::CELDeviceSelector> = None;
...
impl crate::schemars::JsonSchema for DeviceSelector {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.resource.v1beta2.DeviceSelector".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                "cel": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1beta2::CELDeviceSelector>();
                    schema_obj.ensure_object().insert("description".into(), "CEL contains a CEL expression for selecting a device.".into());
                    schema_obj
                }),
            },
        })
...
impl crate::schemars08::JsonSchema for DeviceSelector {
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    (
                        "cel".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1beta2::CELDeviceSelector>().into_object();
