...
impl crate::schemars::JsonSchema for ResourceAttributes {
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                "fieldSelector": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::authorization::v1::FieldSelectorAttributes>();
                    schema_obj.ensure_object().insert("description".into(), "fieldSelector describes the limitation on access based on field.  It can only limit access, not broaden it.".into());
                    schema_obj
                }),
                "group": {
                ...
                "labelSelector": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::authorization::v1::LabelSelectorAttributes>();
                    schema_obj.ensure_object().insert("description".into(), "labelSelector describes the limitation on access based on labels.  It can only limit access, not broaden it.".into());
                    schema_obj
                }),
                "name": {
...
impl crate::schemars08::JsonSchema for ResourceAttributes {
                ...
                properties: [
                    (
                        "fieldSelector".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("fieldSelector describes the limitation on access based on field.  It can only limit access, not broaden it.".into()),
                                ..Default::default()
                            }));
                    ...
                    (
                        "labelSelector".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("labelSelector describes the limitation on access based on labels.  It can only limit access, not broaden it.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
