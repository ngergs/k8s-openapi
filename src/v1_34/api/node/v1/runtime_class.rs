    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "overhead": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::node::v1::Overhead>();
                    schema_obj.ensure_object().insert("description".into(), "overhead represents the resource overhead associated with running a pod for a given RuntimeClass. For more details, see\n https://kubernetes.io/docs/concepts/scheduling-eviction/pod-overhead/".into());
                    schema_obj
                }),
                "scheduling": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::node::v1::Scheduling>();
                    schema_obj.ensure_object().insert("description".into(), "scheduling holds the scheduling constraints to ensure that pods running with this RuntimeClass are scheduled to nodes that support it. If scheduling is nil, this RuntimeClass is assumed to be supported by all nodes.".into());
                    schema_obj
                }),
            },
            "required": [
...
impl crate::schemars08::JsonSchema for RuntimeClass {
