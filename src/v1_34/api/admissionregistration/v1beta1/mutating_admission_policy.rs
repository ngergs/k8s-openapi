// Generated from definition io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicy
...
pub struct MutatingAdmissionPolicy {
    ...
    pub spec: Option<crate::api::admissionregistration::v1beta1::MutatingAdmissionPolicySpec>,
}
...
impl crate::ListableResource for MutatingAdmissionPolicy {
    const LIST_KIND: &'static str = "MutatingAdmissionPolicyList";
}
...
impl crate::DeepMerge for MutatingAdmissionPolicy {
...
impl<'de> crate::serde::Deserialize<'de> for MutatingAdmissionPolicy {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            type Value = MutatingAdmissionPolicy;
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::api::admissionregistration::v1beta1::MutatingAdmissionPolicySpec> = None;
...
impl crate::serde::Serialize for MutatingAdmissionPolicy {
...
impl crate::schemars::JsonSchema for MutatingAdmissionPolicy {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicy".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "spec": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::admissionregistration::v1beta1::MutatingAdmissionPolicySpec>();
                    schema_obj.ensure_object().insert("description".into(), "Specification of the desired behavior of the MutatingAdmissionPolicy.".into());
                    schema_obj
                }),
            },
            "required": [
...
impl crate::schemars08::JsonSchema for MutatingAdmissionPolicy {
    ...
    fn json_schema(__gen: &mut crate::schemars08::gen::SchemaGenerator) -> crate::schemars08::schema::Schema {
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                description: Some("MutatingAdmissionPolicy describes the definition of an admission mutation policy that mutates the object coming into admission chain.".into()),
                ..Default::default()
            })),
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "spec".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::admissionregistration::v1beta1::MutatingAdmissionPolicySpec>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("Specification of the desired behavior of the MutatingAdmissionPolicy.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
