...
impl crate::schemars::JsonSchema for PodDisruptionBudget {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.policy.v1.PodDisruptionBudget".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "spec": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::policy::v1::PodDisruptionBudgetSpec>();
                    schema_obj.ensure_object().insert("description".into(), "Specification of the desired behavior of the PodDisruptionBudget.".into());
                    schema_obj
                }),
                "status": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::policy::v1::PodDisruptionBudgetStatus>();
                    schema_obj.ensure_object().insert("description".into(), "Most recently observed status of the PodDisruptionBudget.".into());
                    schema_obj
                }),
            },
            "required": [
...
impl crate::schemars08::JsonSchema for PodDisruptionBudget {
    ...
    fn json_schema(__gen: &mut crate::schemars08::gen::SchemaGenerator) -> crate::schemars08::schema::Schema {
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                description: Some("PodDisruptionBudget is an object to define the max disruption that can be caused to a collection of pods".into()),
                ..Default::default()
            })),
                ...
                properties: [
                    ...
                    (
                        "spec".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("Specification of the desired behavior of the PodDisruptionBudget.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
                    ...
                    (
                        "status".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("Most recently observed status of the PodDisruptionBudget.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
