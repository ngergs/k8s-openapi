    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "valueFrom": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::core::v1::EnvVarSource>();
                    schema_obj.ensure_object().insert("description".into(), "Source for the environment variable's value. Cannot be used if value is not empty.".into());
                    schema_obj
                }),
            },
            "required": [
...
impl crate::schemars08::JsonSchema for EnvVar {
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("Name of the environment variable. May consist of any printable ASCII characters except '='.".into()),
                                ..Default::default()
                            })),
