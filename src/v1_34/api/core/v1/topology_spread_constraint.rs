        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                "labelSelector": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "LabelSelector is used to find matching pods. Pods that match this label selector are counted to determine the number of pods in their corresponding topology domain.".into());
                    schema_obj
                }),
                "matchLabelKeys": {
...
impl crate::schemars08::JsonSchema for TopologySpreadConstraint {
