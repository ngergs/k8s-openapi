        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                "required": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "required specifies hard node constraints that must be met.".into());
                    schema_obj
                }),
            },
        })
...
impl crate::schemars08::JsonSchema for VolumeNodeAffinity {
