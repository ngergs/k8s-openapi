...
impl crate::schemars::JsonSchema for PreferredSchedulingTerm {
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                "preference": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::core::v1::NodeSelectorTerm>();
                    schema_obj.ensure_object().insert("description".into(), "A node selector term, associated with the corresponding weight.".into());
                    schema_obj
                }),
                "weight": {
...
impl crate::schemars08::JsonSchema for PreferredSchedulingTerm {
