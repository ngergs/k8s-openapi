...
impl crate::schemars::JsonSchema for APIService {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIService".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "spec": ({
                    let mut schema_obj = __gen.subschema_for::<crate::kube_aggregator::pkg::apis::apiregistration::v1::APIServiceSpec>();
                    schema_obj.ensure_object().insert("description".into(), "Spec contains information for locating and communicating with a server".into());
                    schema_obj
                }),
                "status": ({
                    let mut schema_obj = __gen.subschema_for::<crate::kube_aggregator::pkg::apis::apiregistration::v1::APIServiceStatus>();
                    schema_obj.ensure_object().insert("description".into(), "Status contains derived information about an API server".into());
                    schema_obj
                }),
            },
            "required": [
...
impl crate::schemars08::JsonSchema for APIService {
    ...
    fn json_schema(__gen: &mut crate::schemars08::gen::SchemaGenerator) -> crate::schemars08::schema::Schema {
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                description: Some("APIService represents a server for a particular GroupVersion. Name must be \"version.group\".".into()),
                ..Default::default()
            })),
                ...
                properties: [
                    ...
                    (
                        "spec".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("Spec contains information for locating and communicating with a server".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
                    ...
                    (
                        "status".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("Status contains derived information about an API server".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
