    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "structuredData": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1alpha2::StructuredResourceHandle>();
                    schema_obj.ensure_object().insert("description".into(), "If StructuredData is set, then it needs to be used instead of Data.".into());
                    schema_obj
                }),
            },
        })
