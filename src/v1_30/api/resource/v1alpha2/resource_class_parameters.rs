        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "filters": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::resource::v1alpha2::ResourceFilter>()),
                },
                "generatedFrom": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1alpha2::ResourceClassParametersReference>();
                    schema_obj.ensure_object().insert("description".into(), "If this object was created from some other resource, then this links back to that resource. This field is used to find the in-tree representation of the class parameters when the parameter reference of the class refers to some unknown type.".into());
                    schema_obj
                }),
                "kind": {
                ...
                "vendorParameters": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::resource::v1alpha2::VendorParameters>()),
                },
            },
            "required": [
                "metadata",
