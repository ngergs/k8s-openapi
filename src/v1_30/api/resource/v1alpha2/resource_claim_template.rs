// Generated from definition io.k8s.api.resource.v1alpha2.ResourceClaimTemplate
...
pub struct ResourceClaimTemplate {
    ...
    pub spec: crate::api::resource::v1alpha2::ResourceClaimTemplateSpec,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::api::resource::v1alpha2::ResourceClaimTemplateSpec> = None;
...
impl crate::schemars::JsonSchema for ResourceClaimTemplate {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.resource.v1alpha2.ResourceClaimTemplate".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "spec": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1alpha2::ResourceClaimTemplateSpec>();
