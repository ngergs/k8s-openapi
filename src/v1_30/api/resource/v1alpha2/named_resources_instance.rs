// Generated from definition io.k8s.api.resource.v1alpha2.NamedResourcesInstance
...
impl crate::DeepMerge for NamedResourcesInstance {
    fn merge_from(&mut self, other: Self) {
        crate::merge_strategies::list::atomic(&mut self.attributes, other.attributes);
        crate::DeepMerge::merge_from(&mut self.name, other.name);
    }
}

impl<'de> crate::serde::Deserialize<'de> for NamedResourcesInstance {
...
impl crate::serde::Serialize for NamedResourcesInstance {
