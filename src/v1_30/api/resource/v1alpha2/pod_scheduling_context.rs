// Generated from definition io.k8s.api.resource.v1alpha2.PodSchedulingContext
...
pub struct PodSchedulingContext {
    ...
    pub spec: crate::api::resource::v1alpha2::PodSchedulingContextSpec,

    /// Status describes where resources for the Pod can be allocated.
    pub status: Option<crate::api::resource::v1alpha2::PodSchedulingContextStatus>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::api::resource::v1alpha2::PodSchedulingContextSpec> = None;
                let mut value_status: Option<crate::api::resource::v1alpha2::PodSchedulingContextStatus> = None;
...
impl crate::schemars::JsonSchema for PodSchedulingContext {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.resource.v1alpha2.PodSchedulingContext".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "spec": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1alpha2::PodSchedulingContextSpec>();
                    schema_obj.ensure_object().insert("description".into(), "Spec describes where resources for the Pod are needed.".into());
                    schema_obj
                }),
                "status": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1alpha2::PodSchedulingContextStatus>();
