...
pub struct ValidatingAdmissionPolicySpec {
    ...
    pub audit_annotations: Option<std::vec::Vec<crate::api::admissionregistration::v1alpha1::AuditAnnotation>>,
    ...
    pub validations: Option<std::vec::Vec<crate::api::admissionregistration::v1alpha1::Validation>>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_audit_annotations: Option<std::vec::Vec<crate::api::admissionregistration::v1alpha1::AuditAnnotation>> = None;
                ...
                let mut value_validations: Option<std::vec::Vec<crate::api::admissionregistration::v1alpha1::Validation>> = None;
...
impl crate::schemars::JsonSchema for ValidatingAdmissionPolicySpec {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.admissionregistration.v1alpha1.ValidatingAdmissionPolicySpec".into()
    }
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                "auditAnnotations": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::admissionregistration::v1alpha1::AuditAnnotation>()),
                },
                "failurePolicy": {
                ...
                "matchConditions": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::admissionregistration::v1alpha1::MatchCondition>()),
                },
                "matchConstraints": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::admissionregistration::v1alpha1::MatchResources>();
                ...
                "paramKind": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::admissionregistration::v1alpha1::ParamKind>();
                ...
                "validations": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::admissionregistration::v1alpha1::Validation>()),
                },
                "variables": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::admissionregistration::v1alpha1::Variable>()),
                },
            },
        })
    }
