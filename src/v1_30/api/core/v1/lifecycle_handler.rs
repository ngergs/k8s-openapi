        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                "exec": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "Exec specifies the action to take.".into());
                    schema_obj
                }),
                "httpGet": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::core::v1::HTTPGetAction>();
                    schema_obj.ensure_object().insert("description".into(), "HTTPGet specifies the http request to perform.".into());
                    schema_obj
                }),
                "sleep": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::core::v1::SleepAction>();
                    schema_obj.ensure_object().insert("description".into(), "Sleep represents the duration that the container should sleep before being terminated.".into());
                    schema_obj
                }),
                "tcpSocket": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::core::v1::TCPSocketAction>();
                    schema_obj.ensure_object().insert("description".into(), "Deprecated. TCPSocket is NOT supported as a LifecycleHandler and kept for the backward compatibility. There are no validation of this field and lifecycle hooks will fail in runtime when tcp handler is specified.".into());
                    schema_obj
                }),
            },
        })
