        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                "lastPhaseTransitionTime": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "lastPhaseTransitionTime is the time the phase transitioned from one to another and automatically resets to current time everytime a volume phase transitions. This is a beta field and requires the PersistentVolumeLastPhaseTransitionTime feature to be enabled (enabled by default).".into());
                    schema_obj
                }),
                "message": {
