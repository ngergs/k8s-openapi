// Generated from definition io.k8s.api.flowcontrol.v1beta3.LimitedPriorityLevelConfiguration
...
pub struct LimitedPriorityLevelConfiguration {
    ...
    pub limit_response: Option<crate::api::flowcontrol::v1beta3::LimitResponse>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_limit_response: Option<crate::api::flowcontrol::v1beta3::LimitResponse> = None;
...
impl crate::schemars::JsonSchema for LimitedPriorityLevelConfiguration {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.flowcontrol.v1beta3.LimitedPriorityLevelConfiguration".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "limitResponse": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::flowcontrol::v1beta3::LimitResponse>();
                    schema_obj.ensure_object().insert("description".into(), "`limitResponse` indicates what to do with requests that can not be executed right now".into());
                    schema_obj
                }),
                "nominalConcurrencyShares": {
